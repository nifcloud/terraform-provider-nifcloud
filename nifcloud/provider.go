...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		Schema: map[string]*schema.Schema{
			...
			"storage_access_key": {
				Description: "This is the NIFCLOUD access key for ObjectStorage Service. It must be provided if you are using ObjectStorage service, but it can also be sourced from the `NIFCLOUD_STORAGE_ACCESS_KEY_ID` env var.",
				Type:        schema.TypeString,
				Optional:    true,
				Sensitive:   true,
			...
			"storage_secret_key": {
				Description: "This is the NIFCLOUD secret key for ObjectStorage Service. It must be provided if you are using ObjectStorage service, but it can also be sourced from the `NIFCLOUD_STORAGE_SECRET_ACCESS_KEY` env var.",
				Type:        schema.TypeString,
				Optional:    true,
				Sensitive:   true,
			...
			"storage_region": {
				Description: "This is the NIFCLOUD region for ObjectStorage Service. It must be provided if you are using ObjectStorage service, but it can also be sourced from the `NIFCLOUD_STORAGE_REGION` env var.",
				Type:        schema.TypeString,
				Optional:    true,
